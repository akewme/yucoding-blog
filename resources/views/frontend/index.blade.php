				...
				<div class="row">
					<div class="col-lg-7">
						<div class="banner_content">
							...
							<h1 class="text-uppercase">Yucoding</h1>
							<h5 class="text-uppercase">Programmer School</h5>
						</div>
					</div>
					<div class="col-lg-5">
						<img width="100%" class="" src="/frontend/img/banner/home-right.png" alt="">
						<div class="float-left">
								<a class="primary_btn mr-2" href="/register"><span>Register</span></a>
								<a class="primary_btn tr-bg" href="/login"><span>Login</span></a>
							</div>
					</div>
				</div>
			</div>
			...
			<div class="row justify-content-start align-items-center">
				...
				<div class="offset-lg-1 col-lg-5">
					<div class="main_title text-left">
						...
						<a class="primary_btn" href="/frontend/#"><span>Download CV</span></a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row portfolio-grid justify-content-center">
					<div class="col-lg-4 col-md-6 all latest">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="/frontend/portfolio-details.html">minimal design</a></h4>
					...
					<div class="col-lg-4 col-md-6 all popular">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="/frontend/portfolio-details.html">Paint wall</a></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all latest">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="/frontend/portfolio-details.html">female light</a></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all popular">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="/frontend/portfolio-details.html">fourth air</a></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all following">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="/frontend/portfolio-details.html">together sign</a></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all upcoming">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="/frontend/portfolio-details.html">multiply fowl</a></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all upcoming following">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="/frontend/portfolio-details.html">green heaven</a></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-6 all upcoming">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="/frontend/portfolio-details.html">season face</a></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
	...
	<div class="testimonial_area section_gap_bottom">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-8 text-center">
					<div class="main_title">
						<h2>client say about yucoding</h2>
