            ...
            <div class="row">
                    ...
                    <div class="categories_post">
                        ...
                        <div class="categories_details">
                            <div class="categories_text">
                                <a href="single-blog.html"><h5>Web Development</h5></a>
                ...
                <div class="col-lg-4">
                    <div class="categories_post">
                        ...
                        <div class="categories_details">
                            <div class="categories_text">
                                <a href="single-blog.html"><h5>Game Development</h5></a>
                                <div class="border_line"></div>
                ...
                <div class="col-lg-4">
                    <div class="categories_post">
                        ...
                        <div class="categories_details">
                            <div class="categories_text">
                                <a href="single-blog.html"><h5>Mobile Development</h5></a>
                                <div class="border_line"></div>
                ...
                <div class="col-lg-4">
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget author_widget">
                            <img width="50%" class="author_img rounded-circle" src="/img/profile.png" alt="">
                            <h4>Yucoding Academy</h4>
                            <p>Programmer Scholl</p>
